...
?>
<input<?php echo($style);?> autocomplete="off" name="<?php echo($inputname);?>" type="text" id="<?php echo($inputname);?>" class="layui-input" size="60" value="<?php echo(($inputvalue));?>">
<?php
if($sbie) {
?>
...
?>
	<iframe id="<?php echo($inputname);?>_iframe" name="<?php echo($inputname);?>_iframe" src="upload.php?inputname=<?php echo($inputname);?>&picsize=<?php echo($pictips);?>" class="uploadfileiframe" border="0"  frameborder="0"  style="margin-top: 10px; width: 110px; height: 40px;"></iframe>
<?php
}	
?>
